...
import difabelzone.backend.repositories.AddressRepository;
...
public class AddressServiceImpl implements AddressService {
     ...
     public AddressDTO updateAddress(Long addressId, AddressDTO addressDTO) {
          ...
          addressFromDatabase.setVillage(addressDTO.getVillage());
          addressFromDatabase.setSubdistrict(addressDTO.getSubdistrict());
